...
const contactInpotPropsSchema=Joi.object({
...
class ContactInput extends React.Component {
  constructor(props) {
    ...
    const validatedProps = validateProps(contactInpotPropsSchema, props, 'ContactInput');
    // inisialisasi state
    this.state = {
      name: '',
      tag: '',
    ...
    this.validatedProps = validatedProps;
  ...
  onSubmitEventHandler(event) {
    ...
    const { addContact } = this.validatedProps;
    addContact({
